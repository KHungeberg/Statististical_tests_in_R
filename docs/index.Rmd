...
It would be nice with some explenation of the code used for each test so the person reading will know how to use the test in R.
  - Also for this i think it could be nice to visualize the test statistic and p-value. 
    The confidence interval would be harder to visualize i think. Could you actually do 
    that?
